...
/*
 * TwoDimArrayPractice Students Work with this Java file On Multi-dimensional Arrays
 */
...
public class TwoDimArrayPractice extends JFrame {
  ...
  /**
   * Fills the array with random numbers between 50 and 80 The instance variable named intArray is
   * the integer array to be filled with values
   */
  ...
  /**
   * Prints array to the console, elements are separated by a space The instance variable named
   * intArray is the integer array to be printed
   */
  ...
  /**
   * Sets all the elements in the specified row to the specified value The instance variable named
  ...
  /**
   * Finds minimum value in the specified column The instance variable named intArray is the integer
   * array
   * 
  ...
  /**
   * Finds the number of times value is found in the array The instance variable named intArray is
   * the integer array
   * 
    ...
    switch (act) {
      ...
      case (2):
        ...
        if (goodInput) {
          ...
          JOptionPane.showMessageDialog(null,
              "Values in row " + rowSelected + " set to " + key + message);
        }
        break;
      ...
      case (3):
        ...
        if (goodInput) {
          ...
          String displayMessageMin =
              "In column " + columnSelected + ", you found a minimum value of ";
