...
public class MgmCompanyGui extends Application {
	...
	{
		if  ( mgmXtxt.getText().equals("") || mgmYtxt.getText().equals("") ||  
				mgmWidthtxt.getText().equals("") || mgmDepthtxt.getText().equals(""))
			return true;
		return false;
	}
				 ...
				 
			{
				...
				// Create management company object with default Plot
					...
					try {
						mgmCompany = new ManagementCompany(mgmNametxt.getText(),
							mgmIdtxt.getText(), Double.parseDouble(mgmFeetxt.getText()),
							Integer.parseInt(mgmXtxt.getText()),
							Integer.parseInt(mgmYtxt.getText()),
							Integer.parseInt(mgmWidthtxt.getText()),
						...
						mgmCompany = new ManagementCompany(mgmNametxt.getText(),
								mgmIdtxt.getText(), Double.parseDouble("10.0"));
					}
				}
	...
	public void start(Stage stage) {
		...
		mgmPlotPane.getChildren().addAll(mgmPlotlbl, mgmXlbl, mgmXtxt, mgmYlbl, mgmYtxt,
				mgmWidthlbl, mgmWidthtxt, mgmDepthlbl, mgmDepthtxt);
